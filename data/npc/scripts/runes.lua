...
shopModule:addBuyableItem({'firebomb'}, 2305, 100,  1, 'firebomb rune')
shopModule:addBuyableItem({'fire field'}, 2301, 100,  1, 'firefield rune')
shopModule:addBuyableItem({'energy bomb'}, 2262, 100,  1, 'firebomb rune')
