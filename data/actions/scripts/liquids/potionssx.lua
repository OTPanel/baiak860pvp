...
local POTIONS = { 
        ...
        [8473] = {empty = 7635, splash = 2, health = {1000, 1100}, level = 130, vocations = {4, 8}, vocStr = "knights"}, -- ultimate health potion 
        [7620] = {empty = 7636, splash = 7, mana = {250, 300}}, -- mana potion 
        [7589] = {empty = 7634, splash = 7, mana = {400, 400}, level = 50, vocations = {1, 2, 3, 5, 6, 7}, vocStr = "sorcerers, druids and paladins"}, -- strong mana potion 
        [7590] = {empty = 7635, splash = 7, mana = {700, 750}, level = 80, vocations = {1, 2, 5, 6}, vocStr = "sorcerers and druids"}, -- great mana potion 
        [8472] = {empty = 7635, splash = 3, health = {150, 250}, mana = {350, 450}, level = 80, vocations = {3, 7}, vocStr = "paladins"}, -- great spirit potion 
} 
