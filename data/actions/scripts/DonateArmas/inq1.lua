...
function onUse(cid, item, frompos, item2, topos)
 if getPlayerStorageValue(cid, 12968) > os.time() then
	...
	wall1 = {x=7056, y=5612, z=14, stackpos=1}
	wall2 = {x=7055, y=5612, z=14, stackpos=1}
	wall3 = {x=7054, y=5612, z=14, stackpos=1}
	wall4 = {x=7053, y=5612, z=14, stackpos=1}
	wall5 = {x=7052, y=5612, z=14, stackpos=1}
	wall6 = {x=7051, y=5612, z=14, stackpos=1}
	wall7 = {x=7050, y=5612, z=14, stackpos=1}
	wall8 = {x=7049, y=5612, z=14, stackpos=1}
	wall9 = {x=7048, y=5612, z=14, stackpos=1}
	wall10 = {x=7047, y=5612, z=14, stackpos=1}
	wall11 = {x=7046, y=5612, z=14, stackpos=1}
	wall12 = {x=7045, y=5612, z=14, stackpos=1}
	wall13 = {x=7044, y=5612, z=14, stackpos=1}
