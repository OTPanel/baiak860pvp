...
function onUse(cid, item, frompos, item2, topos)
 if getPlayerStorageValue(cid, 12968) > os.time() then
	...
	wall1 = {x=7041, y=5615, z=14, stackpos=1}
	wall2 = {x=7041, y=5616, z=14, stackpos=1}
	wall3 = {x=7041, y=5617, z=14, stackpos=1}
	wall4 = {x=7041, y=5618, z=14, stackpos=1}
	wall5 = {x=7041, y=5619, z=14, stackpos=1}
	wall6 = {x=7041, y=5620, z=14, stackpos=1}
	wall7 = {x=7041, y=5621, z=14, stackpos=1}
	wall8 = {x=7041, y=5622, z=14, stackpos=1}
	wall9 = {x=7041, y=5623, z=14, stackpos=1}
