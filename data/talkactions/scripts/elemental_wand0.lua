...
-- /////////////////////Requerimentos///////////////////--
local req_itemid = 12288                                  -- ID do item requerido
local req_itemid1 = 12629                                  -- ID do item requerido
local req_itemid2 = 12661                                  -- ID do item requerido
local req_itemid3 = 12662                                  -- ID do item requerido
local req_itemid4 = 12663                                  -- ID do item requerido
local req_itemid5 = 12664                                  -- ID do item requerido
local req_itemid6 = 12665                                  -- ID do item requerido
...
if getPlayerItemCount(cid, req_itemid) > 0 or getPlayerItemCount(cid, req_itemid1) > 0 or getPlayerItemCount(cid, req_itemid2) > 0 or getPlayerItemCount(cid, req_itemid3) > 0 or  getPlayerItemCount(cid, req_itemid4) > 0 or getPlayerItemCount(cid, req_itemid5) > 0 or getPlayerItemCount(cid, req_itemid6) > 0 then
