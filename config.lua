	ownerName = "Equipe RealBaiak"
	ownerEmail = ""
	url = "http://RealBaiak.com"
	location = "Brasil"


	motd = "Bem vindo ao RealBaiak, sua aventura vai começar!"
	serverName = "RealBaiak"
	loginMessage = "Welcome to RealBaiak."
	...
	advertisingBlock = ".net;servegame;no-ip;baiak-;.com;baiak;.br;.org;budexot;.ddns;.ml;.pl;.biz;lag;lagado;laag;laaag;laaaag;laaaaag;.zapto;,ddns;35.247.221.17,tibiaone"
	...
	maxLevelThresholdForKilledPlayer = 0.9
